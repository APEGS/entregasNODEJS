...
//     //const productIndex = newProducts.findIndex(p=>p.id===parsedId);
//     // let product;
//     // if(findProduct){
//     //     product = await productManager.allowProductToBeAltered();
//     // }
...
//         return res.status(400).send({status:"error",error:"Product doesn't exist"})
//     };
//     console.log('no, hasta aquí');
//     //newProducts[productIndex] = {...newProducts[productIndex],title,description,price,category};
//     const productsDoc = await productManager.findArr(newProducts);
//     console.log('al menos esto sigue funcionando');
//     findProduct = await productManager.allowedToWrite();
//     console.log('aqui?');
//     productsDoc[findProduct] = {...productsDoc[findProduct],title,price,category};
